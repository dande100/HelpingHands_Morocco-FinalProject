...
// const CircularProgressBar = () => {
//   const { store, actions } = useContext(Context);
//   const [stripeProgress, setStripeProgress] = useState(0);
//   const radius = 95;
//   const strokeWidth = 12;
//   const circumference = 2 * Math.PI * radius;

//   const stripeStrokeDashoffset = (1 - stripeProgress / 100) * circumference;
...
//   useEffect(() => {
//     setStripeProgress(store.stripeProgress);
//   }, [store.stripeProgress]);
...
//           strokeWidth={strokeWidth}
//           strokeDasharray={circumference}
//           strokeDashoffset={stripeStrokeDashoffset}
//         />
//         <text
//           x={radius}
//           y={radius}
...
//           dy=".35em"
//           fill="#333"
//           transform={`rotate(95 ${radius} ${radius})`}
//         >
//           {stripeProgress}%
//         </text>
//       </svg>
